				...
				<div class="row justify-content-between align-items-center">
					...
					<div class="col-lg-10 col-md-8 text-center text-lg-right text-md-right">
						<div id="myPageItem" class="header-top-info open">
							<a href="mypage.html"><span> My Page </span></a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="collapse navbar-collapse text-center" id="navbarsExample09">
					...
					<form class="form-lg-inline my-2 my-md-0 ml-lg-4 text-center">
						<div id="goLogInOutParent">
							<a id="goLogin" href="contact.html" class="btn btn-solid-border btn-round-full close"
								value="login">Go Login</a>
							<a id="goLogout" href="contact.html" class="btn btn-solid-border btn-round-full open"
								value="login">Go Logout</a>
						</div>
					</form>
				</div>
			</div>
				...
				<div class="row justify-content-center">
					<div class="col-lg-5">
						<div class="section-title pt-5">
							...
							<h2 class="mt-3 ">플랜 구독으로 더 높은 품질의 서비스를 제공받으세요! </h2>
						</div>
					</div>
						...
						<div class="row">
							<div class="col-lg-6 col-md-6">
								<div class="intro-item mb-4 mb-lg-0">
									...
									<h4 class="mt-4">마법같이 짜여지는 스케쥴</h4>
									<p class="suite-regular-font">원하는 테마만 말씀해주시면, 수많은 경험을 바탕으로 고객님이 원하는 루트를 독심술하듯 짜드릴게요!
									</p>
								</div>
							</div>
							<div class="col-lg-6 col-md-6">
								<div class="intro-item mb-4 mb-lg-0">
									...
									<h4 class="mt-4">끝없는 피드백을 통한 성장</h4>
									<p class="suite-regular-font">여행이 마무리된 고객님들의 후기글, 피드백 점수를 통해 꾸준히 발전해나가고 있어요.</p>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row justify-content-center">
					<div class="col-lg-7 text-center">
						<div class="section-title">
							...
							<h2 class="mt-3 content-title text-white">소정의 금액으로 행복을 찾으세요!</h2>
						</div>
					</div>
				</div>
					...
					<div class="col-md-4">
						<div class="card text-center mb-md-0 mb-3">
							<div class="card-body py-5">
								...
								<ul class="list-unstyled lh-45 mt-3 text-black suite-regular-font">
									<li>- 후기글 탐방</li>
									<li>- 인기 여행지 확인</li>
								</ul>
								<a href="#"
									class="btn btn-small btn-solid-border mt-3 btn-round-full suite-regular-font">가입하기</a>
							</div>
						</div>
					</div>
					<div class="col-md-4">
						<div class="card text-center mb-md-0 mb-3">
							<div class="card-body py-5">
								...
								<a href="#"
									class="btn btn-small btn-main mt-3 btn-round-full suite-regular-font">가입하기</a>
							</div>
						</div>
					</div>
					<div class="col-md-4">
