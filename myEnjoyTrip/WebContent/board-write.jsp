...
<body>
				...
				<div class="col-lg-9 col-md-9 col-sm-0">
					<form id="board-form" action="">
						...
						<div class="form-group">
							<input id="board-title" name="user_id" type="text" class="form-control" placeholder="제목을 입력하세요">
						</div>
		...
		let upload = false;
			...
			function uploadImage(file) {
                ...
                reader.onload = function(e) {
                    ...
                    img.style.maxWidth = "100px"; // 썸네일 최대 너비 설정
					console.log(img);
					thumbnailImg = String(img.outerHTML);
                    //document.getElementById("thumbnail").appendChild(img);
                };
                reader.readAsDataURL(file);
				upload = true;
				}
				$('#summernote').summernote('insertImage', img.src);
            }
    </script>
    ...
    <script>
        ...
        async function getValueBoard() {
            ...
            console.log("TITLE : "+boardTitle.value);
            console.log("Value : \n"+summernoteContent);
            ...
            let response = await fetch("/board/boardInsert", fetchOptions);
